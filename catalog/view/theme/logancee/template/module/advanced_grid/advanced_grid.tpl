...
$advanced_id = $id; ?>
     ...
     <div class="advanced-grid advanced-grid-<?php echo $advanced_id; ?> <?php echo $custom_class; ?> <?php if($disable_on_mobile == 1) echo 'hidden-xs hidden-sm'; ?>" style="margin-top: <?php echo $margin_top; ?>px;<?php if($force_full_width != 1) { ?>margin-left: <?php echo $margin_left; ?>px;margin-right: <?php echo $margin_right; ?>px;<?php } ?>margin-bottom: <?php echo $margin_bottom; ?>px;">
          <?php if($background_image_type == 2) { ?><div class="parallax-window" style="<?php if($background_color != '') { echo 'background-color: ' . $background_color . ';'; } if($background_image != '') { echo 'background-image: url(image/' . $background_image . ');'; } ?>" data-velocity="-0.04"><?php } ?>
                                   ...
                                   <div class="<?php echo $column_width; ?>">
                                        <?php foreach($column['modules'] as $module) { ?>
                                             ...
                                             <?php } else if($module['type'] == 'products_tabs') { 
                                                  if(file_exists('catalog/view/theme/' . $config->get( 'config_template' ) . '/template/module/advanced_grid/products_tabs/' . $module['content']['module_template'] . '')) {
                                                       include('catalog/view/theme/' . $config->get( 'config_template' ) . '/template/module/advanced_grid/products_tabs/' . $module['content']['module_template'] . '');
                                                  } else {
                                                       echo 'Module template doesn\'t found!';
                                                  } ?>	
                                             <?php } else { ?>
