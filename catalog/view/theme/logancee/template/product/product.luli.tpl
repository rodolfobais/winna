  	...
  	<div class="row">
  		...
  		<div class="col-sm-<?php if($theme_options->get( 'custom_block', 'product_page', $config->get( 'config_language_id' ), 'status' ) == 1 || count($product_custom_block)) { echo 9; } else { echo 12; } ?>">
  			<div class="row" id="quickview_product">
				...
				<h2 class="product-name"><?php echo $heading_title; ?> | asdasd</h2>
					
					<div class="modelo">
					<?php echo $text_model; ?> <?php echo $model; ?> </div>
			            ...
			            <div class="main-price">
							...
							<?php echo $price; ?>
			       	        ...
			       	        <?php } else { ?>
								...
								<span class="price-old" id="price-old"><?php echo $price; ?>
							</span>
	  		...
	  		<div class="panel panel-default">
			    <div class="panel-heading">
			      <h4 class="panel-title">
			        <a data-toggle="collapse" data-parent="#accordion" href="#Care">
			          FORMAS DE PAGO
			        </a>
			      </h4>
			    </div>
