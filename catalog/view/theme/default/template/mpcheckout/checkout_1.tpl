<?php echo $header; ?>
<div id="container" class="container mp-container <?php echo $themeclass; ?>">
  <ul class="breadcrumb">
    ...
    <div id="content" class="<?php echo $class; ?>"><?php echo $content_top; ?>
      ...
      <div class="mp-checkout" id="mp-checkout">
        <div class="content-tab">
          <div class="row">
            <div class="col-sm-5 xl-40 xs-100 sm-100 register-panel">
              <?php if(!$logged) { ?>
            ...
            <div class="col-sm-7 xl-60 xs-100 sm-100 journal-mleft">
              <?php if($cart_status) { ?>
              <div class="shoppingcart"><?php echo $shoppingcart_controller; ?></div>
              <?php } ?>
              <div class="row mp-flex">
                <div class="col-sm-12 col-md-6 xl-50 md-50 sm-100 xs-100 shipping_methods padding-right-none mp-flex">
                  <?php echo $shipping_method_controller; ?>
                </div>
                <div class="col-sm-12 col-md-6 xl-50 md-50 sm-100 xs-100 payment_methods mp-flex">
              ...
              <?php } ?>
              <div class="row">
                <div class="col-sm-12 xl-100 xs-100 checkout-button-position">
