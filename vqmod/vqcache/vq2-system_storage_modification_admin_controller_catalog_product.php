...
class ControllerCatalogProduct extends Controller {
  ...
  protected function getInvalidStockMessage($error_status, $link) {
    ...
    $this->load->model('catalog/stock');
        ...
        $this->model_catalog_stock->deleteStock($product_id);
			}
    ...
    $data['entry_no_all_options'] = $this->language->get('sm_entry_no_all_options'); 
		...
		foreach ($product_options as $product_option) {
			...
			if (isset($product_option['product_option_value'])) {
				if (isset($product_option['product_option_value'])) foreach ($product_option['product_option_value'] as $product_option_value) {
					$product_option_value_data[] = array(
          ...
          'stock_enabled'        => (isset($product_option['stock_enabled']) ? $product_option['stock_enabled'] : 0), 
...
'color'		 => $product_image['pi_pcbi_color'],
...
$data['stock_module_enabled'] =  $this->config->get('stock_module_enabled') == 1; 
