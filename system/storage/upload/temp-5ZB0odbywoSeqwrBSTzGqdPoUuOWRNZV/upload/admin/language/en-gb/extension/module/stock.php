...
$_['text_needs_db_update']						= 'The existing module\'s database is out of date. In order for the module to function properly, you need to update your database by clicking the "Fix this" link. Your data will not be affected.';
$_['text_db_update_success']					= 'Module\'s database was succesfully updated to the latest version.';
$_['text_fix']									= 'Fix this';
$_['text_fixing']								= 'Fixing...';
$_['text_validate']								= 'Validate installation';
$_['text_validating']							= 'Validating...';
$_['text_validate_info']						= 'Note: the validation will only check if the required installations steps have been carried out. If the validation is successfull and you still have problems, please contact the extension\'s developer';
$_['text_validate_success']						= 'No problems have been detected with the module\'s installation';
