...
$_['text_mp_ticket'] = '<a onclick="window.open(\'https://www.mercadopago.com\');" target="_blank"><img src="view/image/payment/mp_ticket.png" alt="Mercado Pago" title="Mercado pago" style="border: 1px solid #EEEEEE;" /></a>';
...
$_['error_public_key'] = 'Lo siento, <b>Public Key</b> es obligatorio.';
$_['error_access_token'] = 'Lo siento, <b>Access Token</b> es obligatorio.';
// installments
$_['18'] = '18';
$_['15'] = '15';
$_['12'] = '12';
