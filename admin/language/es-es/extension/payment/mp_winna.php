<?php
// Heading
$_['heading_title'] = 'Mercado Pago Argentina';

// Text
$_['text_payment'] = 'Pago';
$_['text_success'] = 'Éxito! Las modificaciones están listas!';
$_['text_mp_winna'] = '<a onclick="window.open(\'https://www.mercadopago.com\');" target="_blank"><img src="view/image/payment/mp_winna.png" alt="Mercado Pago" title="Mercado Pago" style="border: 1px solid #EEEEEE;" /></a>';
...
$_['error_client_id_and_secret'] = '<b>Client ID y/o Client Secret</b> no valido. Seleccione su país y valide sus credenciales: 
