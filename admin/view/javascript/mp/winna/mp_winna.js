(function() {
  ...
  country.onchange = function() {
    ...
    if (url_site.value != "") {
      ...
      url_backend +=
        "admin/index.php?route=extension/payment/mp_winna/getPaymentMethodsByCountry&country_id=" +
        country +
        "&token=" +
        token;
  ...
  btn_save.onclick = function() {
    ...
    if (selected_payments.length == 0) {
      ...
      $("#div_payments")
        ...
        .focus();
      div_error_methods.innerHTML =
        "<b>Please, select at least one payment method</b>";
      return;
    }
